...
(function(){
  var NAV = [
    ...
    {id:'pattern',       href:'#',                     label:'Pattern Explorer', icon:'<path d="M4 19V5"/><path d="M4 19h16"/><circle cx="9" cy="13" r="1.4"/><circle cx="14" cy="9" r="1.4"/><circle cx="19" cy="12" r="1.4"/>'},
    {id:'flashcards',    href:'#',                     label:'Flashcards',       icon:'<rect x="3" y="6" width="14" height="12" rx="2"/><path d="M7 3h14v12"/>'},
    ...
    {id:'plans',         href:'#',                     label:'Study Plans',      icon:'<rect x="4" y="5" width="16" height="16" rx="2"/><path d="M4 9h16M9 3v4M15 3v4"/>'},
